...
var hiddenCountryList = $.parseJSON($('#hiddenCountryList').val());

var states = hiddenCountryList;
...
$('.typeahead').keyup(function(event) {
    ...
    if (keycode == '13') {
        ...
        var arrayValue = Object.values(hiddenCountryList);
        if ($.inArray(typedValue, arrayValue) == -1) {
            var typedGetValue = $('#typeaheadValue').val(typedValue);
        }
    }
...
// if (arrayValue.indexOf(typedValue) == -1) {
//     console.log('Value not found');
//     var typedGetValue = $('#typeaheadValue').val(typedValue);
// }
// Object.keys(hiddenCountryList)
// });
